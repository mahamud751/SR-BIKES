        ...
        <div>
            <div className="mt-5 p-5">
                ...
                <div className="row p-5">
                        ...
                        <div className=" mt-5">
                            <Accordion defaultActiveKey="0">
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header>Where can I buy a motorcycle from??</Accordion.Header>
                                    <Accordion.Body>
                                        Across the world, we have stores in over 50 countries. They are well equipped to provide you support and guidance to ride a motorcycle of your choice. All you need to do is walk in to a store near you.
                                    </Accordion.Body>
                                </Accordion.Item>
                    ...
                    <div className="col-lg-6 col-md-6 col-12">
                        <img className="img-fluid" src='https://i.ibb.co/J7mBtWx/70397238-507948496418112-8230942810575647904-n.png' alt="" style={{
                            // height: "450px"
                            // width: "450px"
                        }} />
                    </div>
